...
<h1>Your Vehicle Number Plate</h1>
<h6 style="font-weight: lighter;">(We need some Documents to ensure Security)</h6>
<br><br><br>
<form action="http://localhost/wannadrive6.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;margin-left: -15rem">Upload Vehicle Number Plate Photo</label>
