...
<body>
	...
	$sql="update driver set journeydate='".$_POST['Pickup']."',journeytime='".$_POST['Destination']."' where id='".$_POST['id']."'";
	$res=$conn->query($sql);
	if($res){
		?>
		 <form name="wannadrive3" action="wannadrive14.php" method="post">
