...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="text-align: right;background-color: black">
   ...
   <a class="nav-link active" href="http://localhost/pr2-3.php" style="margin-left: 100px;" onMouseOver="this.style.color='yellow'"
...
<h1>Your Price</h1><br>
<br>
<form action="http://localhost/changeprice.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;margin-left: -5rem">Price:</label>
    <input class="v" type="int" name="price"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="Price..."><br><br>
