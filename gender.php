...
<body> <nav class="navbar navbar-expand-lg navbar-dark  fixed-top" style="background-color: black;color: black;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="text-align: right;background-color: black">
   ...
   <a class="nav-link active" href="logintruck.html" style="margin-left: 430px;" onMouseOver="this.style.color='yellow'"
...
<h1>Tell us Something more...</h1><br><br>
<form method="post" action="http://localhost//checking.php">
<select id="cars" name="gender" style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;"required>
  <option value="male">Male</option>
  <option style=" text-align:center;" value="Female">Female</option>
</select><br><br><br><br>
<input  class="v" type="Password" name="Password" placeholder="Your Password" style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left: 8rem;height: 40px;border-radius: 15px;padding-left: 10px;"required> <input id="z" onclick="check()" type="checkbox"><label>Show Password</label> <br><br>
<?php
 ...
 function check() {
  if(a==0){
   ...
   // body...
     ...
     document.querySelector('.v').type="password";
    a=0;
  }
 }
