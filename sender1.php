...
<h1>Weight of Your Package</h1><br>
<br>
<form action="http://localhost/sender2.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;margin-left: -5rem">Weight in kgs</label>
    <input class="v" type="number" name="weight"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" placeholder="for eg. 5"required><br><br>
