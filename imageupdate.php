...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="text-align: right;background-color: black">
    <div class="navbar-nav" style="background-color: black">
      ...
      <a class="nav-link active" href="#" style="margin-left: 50px;" onclick="recent()"onMouseOver="this.style.color='yellow'"
        onMouseOut="this.style.color='white'">Recent Images</a>
         <a class="nav-link active" href="http://localhost/pr2-3.php" style="margin-left: 250px;" onMouseOver="this.style.color='yellow'"
...
<h1>Your Image</h1><br><br><br><br>
<form action="http://localhost/imageupdate2.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;">Select Image File:</label>
    <input class="v" type="file" name="image"style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;" ><br><br>
...
<form method="post" action="http://localhost/recentimage.php" name="recentimage">
