...
<nav class="navbar navbar-expand-lg navbar-dark  fixed-top" style="background-color: black;color: black;">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="text-align: right;background-color: black">
    <div class="navbar-nav" style="background-color: black">
     ...
     <a class="nav-link active" href="name.html" style="margin-left: 420px;" onMouseOver="this.style.color='yellow'"
...
<h1>Your Password</h1><br><br>
<form method="post" action="http://localhost//loggedin2.php">
<input  class="v" type="password" name="password" placeholder="Your Password...." style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;height: 40px;border-radius: 15px;padding-left: 10px;"required><br><br><br><input id="z" type="checkbox" onclick="check()"><label>Show Password</label><br><br>
<?php
