...
<input  class="v" type="text" name="Email" placeholder="Your Emaill ...." style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;;margin-left: 0px;height: 40px;border-radius: 15px;padding-left: 10px; "required><br><br>
<?php
