...
<br><br><br>
<form action="http://localhost/wannadrive8.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;margin-left: -15rem">Upload Vehicle Photo</label>
