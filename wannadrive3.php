...
<h1>Your Vehicle RC</h1>
<h6 style="font-weight: lighter;">(We need some Documents to ensure Security)</h6>
<br><br><br>
<form action="http://localhost/wannadrive4.php" method="post" enctype="multipart/form-data" name="image">
    <label style="font-weight: bolder;margin-left: -15rem">Upload RC Front side image:</label>
...
<footer class="section footer-classic context-dark bg-image" style="background:black;padding-top: 50px;margin-top: 200px;">
  ...
  <input type="text" name="Email" style="display: no" value="<?php echo $_POST['Email'] ?>">
