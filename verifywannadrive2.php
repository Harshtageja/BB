...
<body>
  ...
  $sql="select License,RC,Vehicle,LicenseNumber,NumberPlate,Pickup,Destination from driver where id='".$_POST['id']."'";
  $res=$conn->query($sql);
  if($res->num_rows>0){
    ...
    while($row=$res->fetch_assoc()){
      ?>
      <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['License']);?>" class="card-img-top" style>
      <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['RC']);?>" class="card-img-top" style="width: 1000px;height: 1000px;">
      <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['Vehicle']);?>" class="card-img-top" style="width: 1000px;height: 1000px;">
      <img src="data:image/jpg;charset=utf8;base64,<?php echo base64_encode($row['NumberPlate']);?>" class="card-img-top" style="width: 1000px;height: 1000px;"><br><br>
      <label>License</label>
      <input type="text" name="LicenseNumber" value="<?php echo $row['LicenseNumber'] ?>">
       <label>From</label>
      ...
      <form method="post" action="verifywannadrive3.php">
        ...
        <button type="submit" class="b" >Verify</button></form><br><br><br><br>
          ...
          <form method="post" action="verifywannadrive4.php">
