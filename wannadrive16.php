...
<form action="http://localhost/wannadrive17.php" method="post" enctype="multipart/form-data" name="image">
     <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-form-label">City 1</label>
    <div class="col-sm-10">
      <input type="text" name="via1" class="form-control" id="colFormLabel" placeholder="Via City" style="width: 80%">
    </div>
  </div>
   <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-form-label">City 2</label>
    <div class="col-sm-10">
      <input type="text" name="via2" class="form-control" id="colFormLabel" placeholder="Via City" style="width: 80%">
    </div>
  </div>
     <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-form-label">City 3</label>
    <div class="col-sm-10">
      <input type="text" name="via3" class="form-control" id="colFormLabel" placeholder="Via City" style="width: 80%">
    </div>
  </div>
     <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-form-label">City 4</label>
    <div class="col-sm-10">
      <input type="text" name="via4" class="form-control" id="colFormLabel" placeholder="Via City" style="width: 80%">
    </div>
  </div>
     <div class="form-group row">
    <label for="colFormLabel" class="col-sm-2 col-form-label">City 5</label>
    <div class="col-sm-10">
      <input type="text" name="via5" class="form-control" id="colFormLabel" placeholder="Via City" style="width: 80%">
    </div>
  </div>
