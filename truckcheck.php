...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup" style="text-align: right;background-color: black">
    <div class="navbar-nav" style="background-color: black">
        <a class="nav-link active " onclick="document.forms['status'].submit()" style="margin-left: 250px;cursor: pointer;"onMouseOver="this.style.color='yellow'"
 ...
 $result=$conn->query($sql);
     ...
     <h6 class="card-title">To :  <?php echo $row['de'] ?></h6>
      <h6 class="card-title">Price :  <?php echo $row['price'] ?></h6>
       <h6 class="card-title">Date :  <?php echo $row['Date'] ?></h6>
        ...
        <form action="sender1.php" method="post">
  ...
  <input type="text" name="Email" style="display: none;" value="<?php echo $_POST['Email'] ?>">
    <input type="text" name="pickup" style="display: none;" value="<?php echo $_POST['Pickup'] ?>">
      <input type="text" name="drop" style="display: none;" value="<?php echo $_POST['Drop'] ?>">
<button href="#" type="submit" class="btn btn-dark" style="background-color: black;border-radius:10px;margin-left:1%">Proceed</button></form><form action="message.php" method="post">
<button href="#" type="submit" class="btn btn-dark" style="background-color: black;border-radius:10px;position: relative;top: -2.4rem;left:8rem;">Message</button>
...
?>
  ...
  <form name="home" action="pr2-4.php" method="post">
          ...
          <form name="status" action="senderstatus.php" method="post">
          <input type="text" style="display: none;" name="Email" value="<?php echo $_POST['Email'] ?>">
          <input type="text" name="pickup" style="display: none;" value=<?php echo $_POST['Pickup'] ?>>
                    <input type="text" name="drop" style="display: none;" value=<?php echo $_POST['Drop'] ?>>
