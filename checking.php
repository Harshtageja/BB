...
<h1>Your Image</h1><br><br>
<form action="http://localhost/final.php" method="post" enctype="multipart/form-data">
    <label style="font-weight: bolder;">Select Image File:</label>
    <input class="v" type="file" name="image" style="width: 50%;border: none;font-size: 20px;background-color:#DCDCDC;margin-left:;height: 40px;border-radius: 15px;padding-left: 10px;"required><br><br>
...
?>
<button type="submit" name="submit" class="b">continue</button>
